// class createUser   // by using class keyword 
// {
//     constructor(firstName, lastName, email, age, address, about){
...
// // the constructor will be called the same number of time sas the number of objects that we have created here
